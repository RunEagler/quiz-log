...
import type { TakeQuizSubmitMutation as TakeQuizSubmitMutationType } from '../../components/__generated__/TakeQuizSubmitMutation.graphql'
...
function TakeQuizContent() {
  ...
  const [commitSubmit, isSubmitting] =
    useMutation<TakeQuizSubmitMutationType>(SubmitAttemptMutation)
    ...
    <div>
      <div className="card">
        ...
        <div className="progress-bar">
          <div className="progress-info">
            ...
            <span>
              回答済み: {answeredCount} / {quiz.questions.length}
            </span>
          </div>
      ...
      <div className="card question-card">
        ...
        <div className="navigation-buttons">
          ...
          {isLastQuestion ? (
            <button onClick={handleSubmit} disabled={isSubmitting} className="btn btn-success">
              提出する
            </button>
          ) : (
